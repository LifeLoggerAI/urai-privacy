...
export const cookiePolicy = {
    ...
    content: `
    <p>We use cookies to help improve your experience of our website. This cookie policy is part of URAI's privacy policy, and covers the use of cookies between your device and our site.</p>

    <p>We also provide basic information on third-party services we may use, who may also use cookies as part of their service, though they are not covered by our policy.</p>
